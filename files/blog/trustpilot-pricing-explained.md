...
- **You can't buy individual features à la carte.** Features are bundled into tiers. If you want one feature from a higher tier, you pay for the whole tier.
- **Annual contracts are standard.** Month-to-month pricing exists but is higher and less commonly offered to new customers.
- **"Unlimited" doesn't mean unlimited.** Higher tiers remove hard caps on invitations, but Trustpilot's terms allow them to throttle or charge overages for "excessive" usage.
- **Add-ons cost extra.** Things like API access, additional users, and advanced analytics are add-ons or gated behind higher tiers.
...
| Feature | Included? |
|---------|-----------|
| Business profile on Trustpilot | ✅ |
| Collect organic reviews | ✅ |
| Respond to reviews | ✅ |
| Basic review insights | ✅ (limited) |
...
|---------|-----------|
| Everything in Free | ✅ |
| Send review invitations | ✅ (volume-capped) |
| Automatic Feedback Service (AFS) | ✅ |
| Review tagging | ✅ |
| Basic reporting | ✅ |
| Google Seller Ratings | ❌ (requires higher tier or add-on) |
| API access | ❌ (add-on) |
| Custom branding | ❌ |
...
| Higher/uncapped invitation volume | ✅ |
| Google Seller Ratings | ✅ (typically included) |
| API access | ✅ |
| Advanced analytics & benchmarking | ✅ |
| Dedicated account manager | ✅ |
| Custom branding & widgets | ✅ |
| Multi-location support | ✅ |
| Social proof widgets | ✅ |

**What you actually get:** The full Trustpilot suite. Google Seller Ratings, API access, dedicated support, and enough invitation volume for a business doing significant transaction volume.

**The catch:** Pricing is opaque and negotiable. Businesses report paying anywhere from $599 to $2,000+/month depending on size, industry, geography, and how they came through the sales pipeline. Annual contracts are standard; month-to-month is rare and more expensive.

**Who it's for:** Mid-market and enterprise businesses for whom $7,000–$25,000/year is an acceptable marketing expense. If you're a small business, this tier is almost certainly out of reach.

---

## Hidden and additional costs

Beyond the plan price, these cost Trustpilot users real money:
...
## How Trustpilot's pricing compares
...
**Key difference:** Trustpilot's free plan doesn't include review invitations — the core feature you need to proactively collect reviews. By contrast, Judge.me offers unlimited reviews on its free plan (Shopify-only), and Signed Reviews offers 25 review invitations/month on its free plan (Stripe businesses). Trustpilot's free tier is a listening post, not a collection tool.
